...
const BAID64_ALPHABET = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_~';
...
function calculateChecksum(hri, payload) {
...
function decode(baid64Str, expectedHri = null) {
  let str = baid64Str;
  let hri = '';
  let mnemonic = '';
